...
/**
 * Attribute sync response: summary counters + per-attribute results.
 *
 * @api
 */
interface AttributeSyncResponseInterface
{
    ...
    /**
     * @return \ReadyData\Import\Api\Data\AttributeSyncResultInterface[]
     */
    public function getResults(): array;

    /**
     * @param \ReadyData\Import\Api\Data\AttributeSyncResultInterface[] $results
     * @return $this
     */
