...
This module lives in the `Import/` directory of the `readydata/magento-modules`
package, which registers every ReadyData module in one install — see the
[repository README](../README.md). The former `readydata/module-import` package
